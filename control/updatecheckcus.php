    ...
    $phone = $_REQUEST["phone"];
           ...
           if(empty($cpassword) || $password != $cpassword){
            ...
            if($flag==true){
                ...
                $userQuery=$connection->UpdateUserCus($conobj,"customer",$_POST['fname'],$_POST['lname'], $_POST['email'],$_POST["username"],$_POST["password"], $_POST["dob"], $_POST["address"], $_POST["nid"], $_POST["phone"]);
                if($userQuery==TRUE)
                {
