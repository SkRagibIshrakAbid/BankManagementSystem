...
if (isset($_POST['submit'])) {
    ...
    $userQuery=$connection->UpdateUserEmp($conobj,"employee",$_POST["name"],$_POST['email'],$_POST['username'],$_POST['password'], $_POST['nid'], $_POST['dob'], $_POST['mobile'],$_POST['address']);
    if($userQuery==TRUE)
    {
