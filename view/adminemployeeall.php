...
<body style="background-image: linear-gradient(to right, rgba(255,0,0,0), rgb(87, 137, 194))">
    ...
    <div class='eReg'>
        <h2 class='top-title'>Employee section</h2>  
        </div>
        
        <form name="all1" action= "" onsubmit="return validateForm1()" method="post">
        <div class='rightsearch'>
        <h4 class='e1'>Search employee info:</h4><br>
        ...
        <h4 class='e1'>Update employee info:</h4><br>
        ...
        <h4 class='e1'>Delete employee info:</h4><br>
