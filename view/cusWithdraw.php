...
include("../control/cusWithdrawVal.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="login-box">
        ...
        <label class="label-username" for="username">Withdraw Amount : </label>
        ...
        <input class='reg-button button1' type="submit" name="submits" value="Withdraw">
        
      
        <h4 style="color: red">
            <?php
                echo $validateWithdraw;
                echo $userSearch; 
            ?>
        </h4>  
        <h4 style="color: blue">
        <?php    
            echo $withdrawConfirm;
        ?>
        </h4>
    </div>
    </form>
