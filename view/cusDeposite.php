...
include("../control/cusDepositeVal.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="login-box">
        ...
        <h2 class="login-title">Deposite</h2><br>
        <br>
    
        <label class="label-username" for="username">Deposite Amount : </label>
        ...
        <input class='reg-button button1' type="submit" name="submits" value="Deposite">
        
      
        <h4 style="color: red">
            <?php
                echo $validateDeposite;
                echo $userSearch; 
            ?>
        </h4>  
        <h4 style="color: blue">
        <?php    
            echo $depositeConfirm;
        ?>
        </h4>
    </div>
    </form>
